...
export default function JoroApp() {
  ...
  const Navbar = () => (
    <nav style={css.nav}>
      {/* ── JORO SVG LOGO ── */}
      <svg onClick={() => setView("home")} width="140" height="38" viewBox="0 0 140 38" fill="none"
        xmlns="http://www.w3.org/2000/svg" style={{ cursor:"pointer", flexShrink:0 }}>
        <defs>
          <linearGradient id="lg-icon" x1="0" y1="0" x2="30" y2="30" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor="#7c3aed"/>
            <stop offset="55%" stopColor="#a855f7"/>
            <stop offset="100%" stopColor="#c084fc"/>
          </linearGradient>
          <linearGradient id="lg-text" x1="36" y1="0" x2="140" y2="0" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor="#7c3aed"/>
            <stop offset="100%" stopColor="#c084fc"/>
          </linearGradient>
        </defs>
        {/* Icon background */}
        <rect width="30" height="30" rx="8" fill="url(#lg-icon)"/>
        <rect width="30" height="30" rx="8" fill="white" fillOpacity="0.07"/>
        {/* J letter */}
        <path d="M16 8 L16 19.5 C16 22.5 13.5 24.3 10.8 23.4"
          stroke="white" strokeWidth="3" strokeLinecap="round" fill="none"/>
        <circle cx="16" cy="5.5" r="2" fill="white"/>
        {/* Sparkles */}
        <circle cx="23" cy="7.5" r="1.4" fill="white" fillOpacity="0.55"/>
        <circle cx="26" cy="4.5" r="0.9" fill="white" fillOpacity="0.35"/>
        {/* Wordmark */}
        <text x="38" y="23" fontFamily="'DM Sans','Outfit',sans-serif"
          fontSize="20" fontWeight="900" letterSpacing="-0.5" fill="url(#lg-text)">JORO</text>
        {/* Tagline */}
        <text x="38" y="33" fontFamily="'DM Sans',sans-serif"
          fontSize="6.5" fontWeight="500" letterSpacing="1.5"
          fill={dark ? "rgba(168,85,247,0.65)" : "rgba(124,58,237,0.6)"}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginInlineStart: "auto" }}>
        ...
        {/* Profile */}
        <button onClick={() => setView("profile")} style={{ ...css.btn("ghost", true), padding: "0.4rem" }}>
          <Icon name="user" size={20} color={theme.subtext} />
        </button>
      ...
      <div style={{ maxWidth: "600px", position: "relative", zIndex: 1 }}>
        ...
        <div style={{ marginBottom: "1.5rem" }}>
          <svg width="280" height="78" viewBox="0 0 280 78" fill="none" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <linearGradient id="h-ic" x1="0" y1="0" x2="58" y2="58" gradientUnits="userSpaceOnUse">
                <stop offset="0%" stopColor="#7c3aed"/>
                <stop offset="55%" stopColor="#a855f7"/>
                <stop offset="100%" stopColor="#c084fc"/>
              </linearGradient>
              <linearGradient id="h-tx" x1="70" y1="0" x2="280" y2="0" gradientUnits="userSpaceOnUse">
                <stop offset="0%" stopColor="#7c3aed"/>
                <stop offset="55%" stopColor="#a855f7"/>
                <stop offset="100%" stopColor="#c084fc"/>
              </linearGradient>
            ...
            {/* Icon rounded square */}
            <rect width="58" height="58" rx="16" fill="url(#h-ic)" filter="url(#h-glow)"/>
            <rect width="58" height="58" rx="16" fill="white" fillOpacity="0.08"/>
            {/* Inner shine */}
            <rect x="4" y="4" width="28" height="18" rx="6" fill="white" fillOpacity="0.1"/>
            {/* J letterform */}
            <path d="M31 15 L31 37 C31 43.5 26.5 47.5 21 46"
              stroke="white" strokeWidth="6" strokeLinecap="round" fill="none"/>
            <circle cx="31" cy="10.5" r="3.8" fill="white"/>
            {/* Sparkle dots */}
            <circle cx="44" cy="15" r="2.6" fill="white" fillOpacity="0.55"/>
            <circle cx="51" cy="9"  r="1.6" fill="white" fillOpacity="0.35"/>
            <circle cx="47" cy="7"  r="0.9" fill="white" fillOpacity="0.2"/>
            {/* JORO wordmark */}
            <text x="72" y="48" fontFamily="'DM Sans','Outfit',sans-serif"
              fontSize="50" fontWeight="900" letterSpacing="-2.5"
              fill="url(#h-tx)">JORO</text>
            {/* Dot accent on O */}
            <circle cx="268" cy="14" r="5" fill="#a855f7" fillOpacity="0.7"/>
            <circle cx="268" cy="14" r="2.5" fill="#c084fc"/>
            {/* Tagline */}
            <text x="74" y="66" fontFamily="'DM Sans',sans-serif"
              fontSize="9.5" fontWeight="600" letterSpacing="3.5"
              fill={dark ? "rgba(192,132,252,0.7)" : "rgba(124,58,237,0.65)"}>
              SHOP GLOBAL · PAY LOCAL
            </text>
          </svg>
        </div>

        <p style={{ color: theme.subtext, fontSize: "1.05rem", marginBottom: "2rem", lineHeight: 1.7, maxWidth: "480px" }}>
      ...
      <div style={{ paddingTop: "64px", display: "flex" }}>
        ...
        <div style={css.adminSidebar}>
          <div style={{ padding: "1rem 1.2rem", borderBottom: `1px solid ${theme.border}`, marginBottom: "0.5rem" }}>
            <svg width="100" height="28" viewBox="0 0 140 38" fill="none" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <linearGradient id="sb-icon" x1="0" y1="0" x2="30" y2="30" gradientUnits="userSpaceOnUse">
                  <stop offset="0%" stopColor="#7c3aed"/><stop offset="55%" stopColor="#a855f7"/><stop offset="100%" stopColor="#c084fc"/>
                </linearGradient>
                <linearGradient id="sb-text" x1="36" y1="0" x2="140" y2="0" gradientUnits="userSpaceOnUse">
                  <stop offset="0%" stopColor="#7c3aed"/><stop offset="100%" stopColor="#c084fc"/>
                </linearGradient>
              </defs>
              <rect width="30" height="30" rx="8" fill="url(#sb-icon)"/>
              <rect width="30" height="30" rx="8" fill="white" fillOpacity="0.07"/>
              <path d="M16 8 L16 19.5 C16 22.5 13.5 24.3 10.8 23.4" stroke="white" strokeWidth="3" strokeLinecap="round" fill="none"/>
              <circle cx="16" cy="5.5" r="2" fill="white"/>
              <circle cx="23" cy="7.5" r="1.4" fill="white" fillOpacity="0.55"/>
              <circle cx="26" cy="4.5" r="0.9" fill="white" fillOpacity="0.35"/>
              <text x="38" y="23" fontFamily="'DM Sans','Outfit',sans-serif" fontSize="20" fontWeight="900" letterSpacing="-0.5" fill="url(#sb-text)">JORO</text>
              <text x="38" y="33" fontFamily="'DM Sans',sans-serif" fontSize="6.5" fontWeight="500" letterSpacing="1.5" fill="rgba(168,85,247,0.65)">ADMIN PANEL</text>
            </svg>
          </div>
          {adminNav.map(item => (
            <button
